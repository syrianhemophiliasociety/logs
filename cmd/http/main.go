...
import (
	...
	"syrianhemophiliasociety/logs-web/handlers/apis"
	...
	"syrianhemophiliasociety/logs-web/handlers/middlewares/ismobile"
	"syrianhemophiliasociety/logs-web/handlers/middlewares/locale"
	"syrianhemophiliasociety/logs-web/handlers/middlewares/logger"
	"syrianhemophiliasociety/logs-web/handlers/middlewares/theme"
	"syrianhemophiliasociety/logs-web/handlers/middlewares/version"
	"syrianhemophiliasociety/logs-web/handlers/pages"
	"syrianhemophiliasociety/logs-web/handlers/static"
	"syrianhemophiliasociety/logs-web/log"
	"syrianhemophiliasociety/logs-web/redis"
