...
var arabic = Keys{
	...
	MedicineFactor:                "مصدر العامل",
	EnterMedicineFactor:           "أدخل مصدر العامل",
	...
	BloodTestDisplayInBriefNotice: "هذا التحليل سيظهر في ملف المريض المختصر",
	...
	BloodTestDisplayInBrief:       "أظهر هذا التّحليل في ملف المريض المختصر",
	EnterBloodTestDisplayInBrief:  "أظهر هذا التّحليل في ملف المريض المختصر",
	...
	PatientParentsNames:           "Patient parent names",
	...
	EnterPhoneNumberCountryCode:   "أدخل رمز البلد",
	Diagnosis:                     "التّشخيص",
	PatientSonOf:                  "ابن",
	...
	PatientBriefProfile:           "الملف المختصر",
	...
	WBDR:                          "رقم المريض في السجل العالمي",
	...
	ProphylaxesTitle:              "نوع العلاج الوقائي",
	ProphylaxesFrequency:          "تواتر العلاج الوقائي",
	ProphylaxesEndDate:            "تاريخ نهاية العلاج الوقائي",
	ProphylaxesMedicineDose:       "الجرعة",
	ProphylaxesEvery4Weeks:        "كل 4 أسابيع",
	ProphylaxesEvery2Weeks:        "كل أسبوعين",
	ProphylaxesOnceInWeek:         "مرة أسبوعياً",
	ProphylaxesTwiceInWeek:        "مرتان أسبوعياً",
	ProphylaxesThriceInWeek:       "ثلاث مرات أسبوعياً",
	Prophylaxis:                   "العلاج الوقائي",
	ProphylaxisMarkChosen:         "اختيار هذا العلاج للمريض",
	ProphylaxisEnd:                "نهاية فترة العلاج الوقائي",
	ProphylaxisChoose:             "اختر العلاج الوقائي",
	...
	UseMedicineParagraph:      "هذه هي الأدوية الموصوفة من زيارتك الأخيرة لنا، يرجى اختيار الدواء الذي ستستخدمه والنقر على \"أرسل المحتوى\".",
	ImportPatients:            "استيراد سجلات المرضر",
	ImportPatientRecords:      "استيراد سجلات المرضر",
	SelectPatientRecordsFile:  "حدد ملف سجلات المرضى",
	GenerateCard:              "أنشئ بطاقة المريض",
	UpdateProfile:             "تعديل ملف المريض",
	SaveProfile:               "حفظ ملف المريض",
	ProfileDetails:            "تفاصيل ملف المريض",
	VisitStartDate:            "تاريخ البداية",
	VisitEndDate:              "تاريخ النهاية",
	Treatment:                 "العلاج",
	ChooseTreatment:           "اختر العلاج",
	TreatmentTitle:            "Treatment title",
	EnterTreatmentTitle:       "Enter treatment title",
	TreatmentArabicTitle:      "Treatment Arabic title",
	EnterTreatmentArabicTitle: "Enter treatment Arabic title",
	TreatmentType:             "Treatment type",
	EnterTreatmentType:        "Enter treatment type",
	...
	DiagnosisICD11:                  "Diagnosis ICD11",
	EnterDiagnosisICD11:             "Enter diagnosis' ICD11",
	DiagnosisAKA:                    "Diagnosis Also known as",
	EnterDiagnosisAKA:               "Enter diagnosis' Also known as",
	DiagnosedAt:                     "Diagnosed at",
	NationalitySyrian:               "سوري",
	NationalityPalestinian:          "فلسطيني",
	NationalityTurkish:              "تركي",
