...
var english = Keys{
	...
	UseMedicineParagraph:      "Here are the prescribed medicines from the last time you visited us, kindly select the medicine you're going to use and click on \"Submit\".",
	ImportPatients:            "Import Patients",
	ImportPatientRecords:      "Import patients records",
	SelectPatientRecordsFile:  "Select patient records file",
